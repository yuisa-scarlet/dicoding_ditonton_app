...
void main() {
  ...
  group('get Now Playing Movies', () {
    ...
    test('should return list of Movie Model when the response code is 200',
      ...
      // arrange
      when(mockHttpClient
              .get(Uri.parse('$baseUrl/movie/now_playing?$apiKeyQuery')))
          .thenAnswer((_) async =>
  ...
  group('get Popular Movies', () {
    ...
    test('should return list of movies when response is success (200)',
        () async {
      // arrange
      when(mockHttpClient.get(Uri.parse('$baseUrl/movie/popular?$apiKeyQuery')))
          .thenAnswer((_) async =>
  ...
  group('get Top Rated Movies', () {
    ...
    test('should return list of movies when response code is 200 ', () async {
      // arrange
      when(mockHttpClient
              .get(Uri.parse('$baseUrl/movie/top_rated?$apiKeyQuery')))
          .thenAnswer((_) async =>
  ...
  group('get movie detail', () {
    ...
    test('should return movie detail when the response code is 200', () async {
      // arrange
      when(mockHttpClient.get(Uri.parse('$baseUrl/movie/$tId?$apiKeyQuery')))
          .thenAnswer((_) async =>
  ...
  group('get movie recommendations', () {
    ...
    test('should return list of Movie Model when the response code is 200',
      ...
      when(mockHttpClient.get(
              Uri.parse('$baseUrl/movie/$tId/recommendations?$apiKeyQuery')))
  ...
  group('search movies', () {
    ...
    test('should return list of movies when response code is 200', () async {
      // arrange
      when(mockHttpClient.get(
              Uri.parse('$baseUrl/search/movie?$apiKeyQuery&query=$tQuery')))
          .thenAnswer((_) async => http.Response(
